...
function _escapeHtmlAndSanitize(input) {
  ...
  function checkHistory(){
        ...
        row='<li class="link"><span class="long-link">'+_escapeHtmlAndSanitize(longLink)+'</span><span><span class="short-link"><a href="'+_escapeHtmlAndSanitize(shortLink)+'" target="_blank" title="Shortened URL for '+_escapeHtmlAndSanitize(longLink)+'">'+_escapeHtmlAndSanitize(shortLink)+'</a></span><span class="copy"><button class="button button-secondary">Copy</button></span></span></li>';
    ...
    row='<ul class="error-list" style="display:none" role="alert"><li class="error text-center align-center"><span>'+ _sanitizeInput(message) +'</span></li></ul>';
