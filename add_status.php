...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $r_id = filter_var($_POST['r_id'], FILTER_VALIDATE_INT);
    $text = filter_var($_POST['status_'], FILTER_SANITIZE_STRING);

    if ($r_id !== false && $text !== false) {
        // Prepare and execute DELETE statement
        $query = "DELETE FROM statuses WHERE r_id = ?";
        $stmt = $mysqli->prepare($query);
        $stmt->bind_param("i", $r_id);
        $stmt->execute();

        // Prepare and execute INSERT statement
        $query = "INSERT INTO statuses (r_id, text) VALUES (?, ?)";
        $stmt = $mysqli->prepare($query);
    ...
    $mysqli->close();
    header("Location: add_status.php?r_id=" . urlencode($r_id));
    exit;
}
    ...
    // if ($fileType !== "mp4" && $fileType !== "mov" && $fileType !== "avi" && !in_array($fileType, array("jpg", "png", "jpeg", "gif"))) {
    ...
    //         $insertQuery = "INSERT INTO ad_files (file_name, file_type, display_count) VALUES ('$fileName', '$fileType', $displayCount)";
...
<!-- <ul id="sidemenu" class="medium-horizontal menu">
    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-70"><a id="sidemenu-login"
    ...
    <?php if (!isset($_SESSION['username'])) { ?>
        ...
        <li class="button menu-item menu-item-type-custom menu-item-object-custom menu-item-8991"><a
                id="sidemenu-get-a-quote-2" href="signup.php">Sign up</a></li>
    <?php } else { ?>
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-70"><a id="sidemenu-login"
                href="logout.php">Log out</a></li><?php } ?>
    <?php if (isset($_SESSION['username'])) { ?>
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-70"><a id="sidemenu-login"
                href="manage_url.php">Manage</a></li><?php } ?>
    <?php if (isset($_SESSION['username'])) { ?>
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-70"><a id="sidemenu-login"
                href="all_ads.php">Ads Panel</a></li><?php } ?>
...
<div class="container-box">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="status_">
        <br>
        <input type="hidden" name="r_id" value="<?php echo $_GET['r_id']; ?>">
        <input type="submit" name="submit" class="button button-primary sign-up-in" value="Update status">
