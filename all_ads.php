...
// Use the result set to fetch the rows (e.g., while loop or other logic)
...
<div class="off-canvas-content" data-off-canvas-content>
    <header class="header sticky is-stuck" role="banner" data-sticky data-options="marginTop:0;" data-sticky-on="small"
        data-check-every="0">
    ...
    <div class="container">
        <div class="button-create">
            <a id="sidemenu-login" href="ads_control.php">
