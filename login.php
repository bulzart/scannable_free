...
<head>
  ...
  <style>
    body {
      ...
      margin: 0;
      padding: 0;
      background-image: url('https://i.postimg.cc/pL3Q9W6q/cbsradford-image-22.jpg');
...
<body class="registration-pages sign_in">
  ...
  <div class="container-header">
    <h2 class=""><a href="https://scannabl.ink" style="text-decoration:none; color:#fff" rel="nofollow">Scannable</a>
    </h2>
  ...
  <div class="container-box title">
    ...
    <h3 class="switch to-sign-up tagline" style="color: #fff">LINK MANAGEMENT SOFTWARE <br class="br">FOR DIGITAL
      BROADCASTERS</h3>
    <!--  <div class="t-center">-->
        ...
        <div class="social-sign-in">
          <a id="google-sign-up" rel="nofollow" href="https://bitly.com//a/add_google_account?rd=%2f"
            class="susi-btn social-susi-btn button" data-network="google"><img
              src="https://d1ayxb9ooonjts.cloudfront.net/bitly2/7D3D4B49B3CB108E9DD416FA967849FBABBC49CF.svg"
              alt="Google" width="20"><span class="sign-up-text">Sign up with Google</span></a>
        </div>
